...
<body>
    ...
    <div class="left">
                ...
                <div class="textbox1">
                <h1>Thank you<br/>for joining us!</h1><br/>
                <p>Your account has been created!<br>You can log in now:</p><br/><br/>
                <button class="reg-btn" onclick="window.location='../login/login.php';">LOG IN</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <br/></div>
    ...
    <div class="right">
    <img src="../images/lp2.png" class="w2" alt="luggage pic" >
    </div>
    </div>
